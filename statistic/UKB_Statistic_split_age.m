...
parpool('local', 20);
median_age = median(UKB_UsedData_Brain.AgeAttend_2_0);

%% Part1 left_right
cd('/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/result_table_allsubject/left_right');
csvFiles = dir('*.csv');
for i = 1:length(csvFiles)
    ...
    tablePath_upper = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_upper/left_right','/',name];
    mkdir(tablePath_upper);
    tablePath_lower = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_lower/left_right','/',name];
    mkdir(tablePath_lower);
    ukb_RedSyn_table = readtable(csvFileName);
    ukb_RedSyn_upper = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 >= median_age, :);
    ukb_RedSyn_lower = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 < median_age, :);
    get_ukb_statistic_result(ukb_RedSyn_upper,UKB_UsedData_Brain,formula,XListAll,tablePath_upper)
    get_ukb_statistic_result(ukb_RedSyn_lower,UKB_UsedData_Brain,formula,XListAll,tablePath_lower)
end

%% Part2 extra_intra
cd('/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/result_table_allsubject/extra_intra');
csvFiles = dir('*.csv');
for i = 1:length(csvFiles)
    cd('/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/result_table_allsubject/extra_intra');
    disp(i);
    csvFileName = csvFiles(i).name; 
    name = csvFileName(1:end-4);
    tablePath_upper = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_upper/extra_intra','/',name];
    mkdir(tablePath_upper);
    tablePath_lower = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_lower/extra_intra','/',name];
    mkdir(tablePath_lower);
    ukb_RedSyn_table = readtable(csvFileName);
    ukb_RedSyn_upper = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 >= median_age, :);
    ukb_RedSyn_lower = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 < median_age, :);
...
%% Part3 homotopy
cd('/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/result_table_allsubject/homotopy');
csvFiles = dir('*.csv');
for i = 1:length(csvFiles)
    cd('/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/result_table_allsubject/homotopy');
    disp(i);
    csvFileName = csvFiles(i).name; 
    name = csvFileName(1:end-4);
    tablePath_upper = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_upper/homotopy','/',name];
    mkdir(tablePath_upper);
    tablePath_lower = ['/public/home/yangsy/Brain/Brain_project/UKB_02_PhiID_glasser/result/score_table_split_age/score_table_lower/homotopy','/',name];
    mkdir(tablePath_lower);
    ukb_RedSyn_table = readtable(csvFileName);
    ukb_RedSyn_upper = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 >= median_age, :);
    ukb_RedSyn_lower = ukb_RedSyn_table(ukb_RedSyn_table.AgeAttend_2_0 < median_age, :);
